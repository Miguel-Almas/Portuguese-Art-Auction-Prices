...
df_cml = pd.read_csv('C:\\Users\\miguel.almas\\OneDrive - insidemedia.net\\DataScience\\Portuguese-Art-Auction-Prices\\data_cml_processed.csv',index_col=0)
...
list_feats = ['1 Author','1 Author Birth Decade','Auction Number','Shape','Dominant Colour Name']
...
def graph_nbr_sold_unsold_artworks(value,col):
    ...
    # Change the bar mode
    fig_sold_unsold_artworks.update_layout(barmode='stack',title='Sold and unsold artworks by '+ col)
...
def table_artists(value):
    ...
    tmp = tmp.rename(columns={'Final Price':'Price'})
